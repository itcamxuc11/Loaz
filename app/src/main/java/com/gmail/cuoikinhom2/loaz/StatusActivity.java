    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSaveStatusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Progress
                mProgressDailog.setTitle("Lưu thay đôi");
                mProgressDailog.setMessage("Vui lòng đợi");
                ...
                mStatusDatabase.child("status").setValue(status).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(getApplicationContext(),"Có lỗi trong quá trình cập nhật", Toast.LENGTH_LONG).show();
                    }
                });
