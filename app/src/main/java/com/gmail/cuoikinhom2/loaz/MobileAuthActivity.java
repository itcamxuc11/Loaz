            ...
            public void onClick(View view) {
                ...
                if (btnType==0) {
                    ...
                    if (phoneNumber.length() == 13) {
                        ...
                        phoneET.setError("Giá trị không hợp lệ");
                    }
                }
                else {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    errorText.setText("Số điện thoại không đúng");
                    Log.d("error",e.getLocalizedMessage());
                } else {
                    errorText.setText(e.getMessage());
                    Log.d("error",e.getLocalizedMessage());
            ...
            public void onCodeSent(String verificationId, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                sendCodeBT.setText("Mã xác nhận");
            }
        };
...
//                            Toast.makeText(MobileAuthActivity.this,"Code sent", Toast.LENGTH_SHORT).show();
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                errorText.setText("Mã xác nhận sẽ được gửi đến điện thoai của bạn");
